        ...
        <div class="row">
	        <div class="col-lg-12">
	        	<div class="card">
	        		<div class="card-body">
	        			<div>
										<h4 class="title pt-3">Upload CSV</h4>
									<!-- 	<div class="d-flex justify-content-end">
											<h5 class="card-title"> <a href="#" class="btn btn-primary btn-sm me-2">Upload Bulk CSV File </a></h5>
								...
								<div id="dropzone" onClick="selectFile(event)">
									...
									<input id="file" type='file' accept='.csv' onChange="openFile(event)">
								</div>
