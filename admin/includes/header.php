...
?>
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2 profpicname"><?php echo $getUser['fname'];?></span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile" style="background: #dceefa;">
            <li class="dropdown-header profpicname">
              <h6 class="profpicnames"><?php echo $getUser['fname'];?></h6>
          ...
          <li>
           ...
           <!--  <li>
            ...
            <!-- <li>
              <a class="dropdown-item d-flex align-items-center" href="change_passcode.php">
