...
<!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="manage-members.php">
        <i class="bi bi-journal-text"></i>
          <span>Members</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="manage-matches.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="manage-payments.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="manage-tickets.php">
        <i class="bi bi-person"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gear"></i><span>Settings</span><i class="bi bi-chevron-down ms-auto">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
          <?php 
$getPolicy = $db->select(array("*"),PREFIX."settings");

if($getPolicy){
foreach ($getPolicy as $gp) {
	// code...
...
?>
						...
						<a href="change-settings.php?id=<?php echo base64_encode($gp->id);?>">
            <i class="bi bi-circle">
              </i><span>General Settings</span>
          </a>
          ...
          <li>
            <a href="manage-reasons.php">
              <i class="bi bi-circle"></i><span>Reason</span>
            </a>
          </li>
          <li>
