          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Chapters <span>/ This Month</span></h5>
            ...
            <!--Users card-->
            <div class="col-xxl-4 col-md-4">
              <div class="card info-card speaker-card">
                  ...
                  <script>
                    document.addEventListener("DOMContentLoaded", () => {
                      new ApexCharts(document.querySelector("#reportsChart"), {
                        series: [{
                          name: 'Month',
                          data: [31, 40, 28, 51, 42, 82, 56, 84, 75, 55, 61, 88],
                        }, {
                          name: 'year',
                          data: [11, 32, 45, 32, 34, 52, 41, 63, 77, 70, 55, 90 ]
                        }],
                        chart: {
                          height: 350,
                          type: 'area',
