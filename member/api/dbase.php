	  ...
	  function  Dbase($db_nsme=""){
		...
		if ($this->connectHost()) {
			...
			if (!($this->connectDB())) {
				...
				exit("There is some problem with Database Connections, please contact Database administrator! <br>".$this->DATABASE."<br>".mysqli_error());
			...
			exit("There is some problem with Database Connections, please contact Database administrator! <br>".$this->MYSQL_HOST."<br>".mysqli_error());
...
//echo $query
...

	{
		...
		*/
		...
		$total_pages = mysqli_fetch_array(mysqli_query($this->dbLink,$query));
		...
		{	
			...
			{	
...

				{
					...
					if ($counter == $page)
						...
						$pagination.= "<a class=\"number\" href=\"$targetpage&page=$counter\">$counter</a>";					
...

			{
...

				{
					...
					$pagination.= "<a class=\"number\" href=\"$targetpage&page=$lpm1\">$lpm1</a>";



					$pagination.= "<a class=\"number\" href=\"$targetpage&page=$lastpage\">$lastpage</a>";		
...

				{
					...
					$pagination.= "<a class=\"number\" href=\"$targetpage&page=1\">1</a>";



					$pagination.= "<a class=\"number\" href=\"$targetpage&page=2\">2</a>";
	...
	function pagination123($table,$where="",$target_p,$limit=10,$page_no,$adjacent=1)
		...
		*/
		...
		{	
			...
			if ($page > 1) 
				...
				$pagination.= "<a class=\"number\" href=\"$targetpage&page=$prev\"> Prev</a>";
				...
				$pagination.= "<a class=\"number\" > Prev</a>";	
			...
			if ($page < $counter - 1) 
				...
				$pagination.= "<a class=\"number\" href=\"$targetpage&page=$next\">Next</a>";
				...
				$pagination.= "<a  class=\"number\" >Next </a>";
